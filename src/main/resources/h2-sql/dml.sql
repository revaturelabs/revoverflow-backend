...
insert into questions (accepted_id, title, content, creation_date, status, user_id)
values (NULL, 'dasf;ldajdf;lasfdk', 'lala', '2012-12-12', false, 13);

insert into questions (accepted_id, title, content, creation_date, status, user_id)
values (NULL, 'test', 'test', '2012-12-12', false, 13);
